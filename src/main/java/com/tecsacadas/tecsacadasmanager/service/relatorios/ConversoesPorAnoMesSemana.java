...
public class ConversoesPorAnoMesSemana {
    ...
    public void gerar(String ano) {
        ...
        Sheet sheet = workbook.createSheet("Conversões por Ano, Mês e Semana");
        ...
        String fileLocation = path.substring(0, path.length() - 1) + "RelatorioConversoesPorAnoMesSemana.xlsx";
